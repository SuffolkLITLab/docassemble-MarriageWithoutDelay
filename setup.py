...
setup(name='docassemble.MarriageWithoutDelay',
      ...
      author='Matthew Milward',
      author_email='mmilward@su.suffolk.edu',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/MarriageWithoutDelay/', package='docassemble.MarriageWithoutDelay'),
     )
